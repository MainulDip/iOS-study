...
### Moving `Info.plist` file:
If `Info.plist` file has been moved to other place, it need to be specified in `Project-Navigator -> Targets -> Build Settings -> Packaging -> Info.plist file`