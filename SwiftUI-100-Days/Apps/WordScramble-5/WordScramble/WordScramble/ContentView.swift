...
//  WordScramble
//
//  Created by Mainul Dip on 12/16/23.
//
...
struct ContentView: View {
            ...
            List {
                Section {
                    TextField("Enter your word", text: $newWord)
                        ...
                        .onSubmit(addNewWord)
                        .onAppear(perform: startGame) // start the function when UI first initialized, like onCreate
    ...
    // show error if the word is wrong
